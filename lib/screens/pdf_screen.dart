            ...
            child: pw.Row(
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    pw.Text('Date: ${_today()}',
                        style: pw.TextStyle(fontSize: 10, color: PdfColors.white70)),
                  ...
                  children: [
                    pw.Text('RISK CLASSIFICATION',
                        style: pw.TextStyle(fontSize: 9,
                            color: PdfColors.white70, fontWeight: pw.FontWeight.bold)),
                    pw.Text(r.riskLevel.toUpperCase(),
                        style: pw.TextStyle(fontSize: 28,
                            color: PdfColors.white, fontWeight: pw.FontWeight.bold)),
                    pw.Text('${r.ahiCategory} Sleep Apnea',
                        style: pw.TextStyle(fontSize: 12, color: PdfColors.white70)),
                  ],
                ),
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.end,
                  children: [
                    pw.Text('AHI Score',
                        style: pw.TextStyle(fontSize: 9, color: PdfColors.white70)),
